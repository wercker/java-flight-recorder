...
# start the recording
JFRCMD="$JAVA_HOME/bin/jcmd $PID JFR.start duration=$WERCKER_JAVA_FLIGHT_RECORDER_DURATION $DELAY $MAXSIZE $MAXAGE $DUMPONEXIT $DUMPONEXITPATH filename=$WERCKER_JAVA_FLIGHT_RECORDER_FILENAME"
