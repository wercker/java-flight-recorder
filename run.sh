...
JFRCMD="$JAVA_HOME/bin/jcmd $PID JFR.start duration=$WERCKER_JAVA_FLIGHT_RECORDER_DURATION $DELAY $MAXSIZE $MAXAGE $COMPRESS filename=$WERCKER_JAVA_FLIGHT_RECORDER_FILENAME"
